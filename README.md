...
- `context8-mcp setup-clients [--mode remote|local --api-key <key> --scope local|user|project --clients codex,claude,goose,amp --dry-run]` – Install Context8 MCP into supported clients using their CLI commands
